...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        sys.stderr.write("Usage: python3 sim_executor.py {yis, ssim, psim, drypsim, dryyis, dryssim} <path to yo file> <path to sim>\n")
        sys.exit(1)
    ...
    if simulator_type == "yis":
        print(execute_yo_file(sys.argv[3], yo_file_path, simulator_type).pretty_str())
